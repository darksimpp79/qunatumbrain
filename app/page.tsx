...
import { Brain, ChevronRight, Menu, X, MessageCircle } from "lucide-react"
      ...
      {isMenuOpen && (
        ...
        >
          <div className="flex flex-col space-y-4">
            <a href="https://t.me/quantumbrain" target="_blank" rel="noopener noreferrer" className="text-white">
              Telegram
            </a>
